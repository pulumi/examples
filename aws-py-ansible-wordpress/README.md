# Deploy Wordpress to AWS EC2 using Pulumi, Ansible, and Python

This project uses Python to demonstrate how to use Pulumi and Ansible together. Pulumi handles provisioning the AWS infrastructure
