...
1. Generate an OpenSSH keypair for use with your server, as per the AWS [requirements][1]:
...
1. Configure the stack so that the public key is used by your EC2 instance, and the private key is used for subsequent SCP and SSH steps that will configure your server after it is stood up:
