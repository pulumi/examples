[![Deploy](../../../.buttons/deploy-with-pulumi-dark.svg)](https://app.pulumi.com/new?template=https://github.com/pulumi/examples/blob/master/aws-yaml-ansible-wordpress/README.md#gh-light-mode-only)
[![Deploy](../../../.buttons/deploy-with-pulumi-light.svg)](https://app.pulumi.com/new?template=https://github.com/pulumi/examples/blob/master/aws-yaml-ansible-wordpress/README.md#gh-dark-mode-only)
...
> * [Java](../../java/aws-java-ansible-wordpress)
> * [Go](../../go/aws-go-ansible-wordpress)
> * [TypeScript](../../ts/aws-ts-ansible-wordpress)
> * [YAML]()
