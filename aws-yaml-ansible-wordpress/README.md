# Deploy Wordpress to AWS EC2 using Pulumi, Ansible, and YAML

This project uses YAML to demonstrate how to use Pulumi and Ansible together. Pulumi handles provisioning the AWS infrastructure
