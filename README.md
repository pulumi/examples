...
[An extension of this sample](cloud-js-thumbnailer-rekognition/) uses AWS Rekognition to find the timestamp with the highest confidence for a particular label.
