...
require (
	...
	github.com/pulumi/pulumi-azure-native-sdk/containerservice/v3 v3.0.0-alpha.2
	github.com/pulumi/pulumi-azure-native-sdk/managedidentity/v3 v3.0.0-alpha.2
