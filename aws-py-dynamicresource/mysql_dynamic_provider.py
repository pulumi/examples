...
class SchemaInputs(object):
    creator_name: Input[typing.Sequence[Creator]]
...
class SchemaProvider(ResourceProvider):
    ...
    def create(self, args):
        ...
        outs = {**args}
        outs['creator_name'] = {'boo': 'hoo'}
        return CreateResult("schema-"+binascii.b2a_hex(os.urandom(16)).decode("utf-8"), outs=outs)
    ...
    def delete(self, id, args):
        ...
        print('executing deletion_script')
...
class Schema(Resource):
    ...
    creator_name: Output[typing.Sequence[Creator]]
