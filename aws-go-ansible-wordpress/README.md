# Deploy Wordpress to AWS EC2 using Pulumi, Ansible, and Go

This project uses Go to demonstrate how to use Pulumi and Ansible together. Pulumi handles provisioning the AWS infrastructure
