...
auth_lambda_role = aws.iam.Role('auth-lambda-role',
                       assume_role_policy="""{
        "Version": "2012-10-17",
        "Statement": [
            {
...
auth_lambda_role_policy = aws.iam.RolePolicy('auth-lambda-role-policy',
                                    role=auth_lambda_role.id,
                                    policy="""{
        "Version": "2012-10-17",
        "Statement": [{
            "Effect": "Allow",
