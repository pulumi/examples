...
func NewServiceDeployment(
	...
	serviceDeployment.Deployment, err = appsv1.NewDeployment(ctx, name, &appsv1.DeploymentArgs{
		...
		Spec: appsv1.DeploymentSpecArgs{
			...
			Replicas: args.Replicas.ToIntOutput(),
				...
				Spec: &corev1.PodSpecArgs{
					Containers: corev1.ContainerArray{
						corev1.ContainerArgs{
							...
							Env:       args.Env.ToEnvVarArrayOutput(),
							Resources: args.Resources.ToResourceRequirementsOutput(),
	...
	servicePorts := portsOutput.ApplyT(
		func(ports []int) []corev1.ServicePort {
