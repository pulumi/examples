...
scale_set = compute.LinuxVirtualMachineScaleSet(
    "vmscaleset",
    resource_group_name=resource_group.name,
    network_interfaces=[compute.LinuxVirtualMachineScaleSetNetworkInterfaceArgs(
        ip_configurations=[compute.LinuxVirtualMachineScaleSetNetworkInterfaceIpConfigurationArgs(
    ...
    custom_data=base64.b64encode(bytes("""
    #cloud-config
    packages:
        - nginx
    """, 'utf-8')).decode('utf-8'),
    ...
    sku="Standard_DS1_v2",
    data_disks=[compute.LinuxVirtualMachineScaleSetDataDiskArgs(
