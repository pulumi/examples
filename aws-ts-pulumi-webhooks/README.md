...
by the Pulumi Cloud. It then echos the event to Slack.
...
- The Pulumi Cloud. If you go to the webhook's page within the Pulumi Cloud, you can navigate to
  recent webhook deliveries. If the Pulumi Cloud has any trouble contacting your webhook handler,
