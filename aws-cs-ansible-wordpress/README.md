# Deploy Wordpress to AWS EC2 using Pulumi, Ansible, and C#

This project uses C# to demonstrate how to use Pulumi and Ansible together. Pulumi handles provisioning the AWS infrastructure
