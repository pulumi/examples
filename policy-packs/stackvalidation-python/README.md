# Stack validation example in Python
...
1. Set up the policy pack:
   ...
   Copy the stack validation policy pack into this directory, then set up a Python virtual environment:
...
1. Edit `__main__.py` and copy/paste the S3 bucket declaration so you are creating 2 buckets.
