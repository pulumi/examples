# Deploy Wordpress to AWS EC2 using Pulumi, Ansible, and TypeScript

This project uses Typescript to demonstrate how to use Pulumi and Ansible together. Pulumi handles provisioning the AWS infrastructure
